...
class Client {
    ...
    public function host_about($host) {
        ...
        $stmt = $this->client->prepare("SELECT OS_NAME as os_name, CPU_NAME as cpu_name, CPU_TEMP as cpu_temp, CPU_POWER as cpu_power, CPU_CORES as cpu_cores, UPTIME as uptime, STORAGE_MAX as storage_max, MEMORY_MAX as memory_max, OS_TIME as os_time, OS_TIMEZONE as os_timezone FROM hosts WHERE ID = :id");
